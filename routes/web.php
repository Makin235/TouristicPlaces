...
use App\http\Controllers\User\UserPlaceController;
use App\http\Controllers\User\UserPlaceGalleryController;
...
Route::middleware('auth')->prefix('admin')->group(function (){
    Route::middleware('admin')->group(function (){
        ...
        Route::prefix('user')->group(function(){
            ...
            Route::get('user_role/{id}', [UserController::class, 'user_role'])->name('admin_user_roles');
            Route::post('user_role_add/{id}', [UserController::class, 'user_role_store'])->name('admin_user_role_add');
            Route::get('user_role_delete/{user_id}/{role_id}', [UserController::class, 'user_role_destroy'])->name('admin_user_role_delete');
        });
    });
});
